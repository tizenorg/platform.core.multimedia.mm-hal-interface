 ...
 * In these cases, @c message_cb, @c add_message_cb and @c remove_message_cb symbols could be removed.
 *
 * @see add_message_cb()
 ...
 * @param[in] audio_handle The audio hal handle
 * @param[in] info The audio volume information
 * @param[out] mute The volume mute state (0: unmute, 1:mute)
 *
 * @return @c 0 on success,
 *         otherwise a negative error value
 * @retval #AUDIO_RET_OK Success
...
/**
 * @brief Gets notified when a stream is connected and disconnectd.
 * @since_tizen 3.0
 * @param[in] audio_handle The audio hal handle
...
/**
 * @brief Gets the buffer attributes
 * @since_tizen 3.0
 * @param[in] audio_handle The audio hal handle
 ...
 * @param[out] maxlength The max length
 * @param[out] tlength The tlength
 * @param[out] prebuf The prebuf
 * @param[out] minreq The minimum req
 * @param[out] fragsize The fragment size
 *
 * @return @c 0 on success,
 *         otherwise a negative error value
 * @retval #AUDIO_RET_OK Success
...
/**
 * @brief Adds the message callback function when audio hal implementation needs to send a message. (optional)
 * @since_tizen 3.0
 * @param[in] audio_handle The audio hal handle
