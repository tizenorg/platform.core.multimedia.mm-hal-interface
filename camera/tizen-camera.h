...
/**
 * @brief Called to register for notifications about various messages from camera HAL.
 * @since_tizen 3.0
...
/**
 * @brief Called to get a preview frame when every preview frame is captured from camera device.
 * @since_tizen 3.0
...
/**
 * @brief Called to get a video frame when every video frame is captured from camera device.
 * @since_tizen 3.0
